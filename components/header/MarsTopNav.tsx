		...
		<nav className={"mars-top-nav"}>
			<div className={"container-xxl mars-top-nav__container"}>
				<div className={"mars-top-nav__contacts"}>
					<Contact
						href={"tel:++91 983 666 9720"}
						label={"+91 983 666 9720"}
						icon={<FontAwesomeIcon icon={faPhoneAlt} />}
					/>
					<Contact
						href={"https://api.whatsapp.com/send?phone=919836669720&text=hello"}
						label={"+91 983 666 9720"}
				...
				<div className={"mars-top-nav__note"}>
					<p>
						...
						<FontAwesomeIcon
							icon={faShippingFast}
							className={"text-theme-color ms-1"}
						/>
					</p>
				</div>
...
const Contact = ({
	...
	return (
		<div className={"mars-top-nav__contact"}>
			{icon && (
				<a className={"mars-top-nav__contact-icon"} href={href}>
					{icon}
				</a>
			)}
